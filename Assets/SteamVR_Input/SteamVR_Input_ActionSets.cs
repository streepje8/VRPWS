...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_controllerset p_controllerset;
        ...
        public static SteamVR_Input_ActionSet_controllerset controllerset
        {
            get
            {
                return SteamVR_Actions.p_controllerset.GetCopy<SteamVR_Input_ActionSet_controllerset>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_controllerset = ((SteamVR_Input_ActionSet_controllerset)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_controllerset>("/actions/controllerset")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.controllerset};
        }
    }
}
